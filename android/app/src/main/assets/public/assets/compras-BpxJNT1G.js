...
import{i as e}from"./storage-BPwMTOLr.js";import{a as t}from"./firebase-CpRCSNy3.js";import{n}from"./store-DsijVbw0.js";import{a as r,f as i,h as a,o,r as s,t as c}from"./dataService-Dg8tCN3C.js";import{a as l,c as u,d,f,g as p,h as m,i as h,l as g,m as _,o as v,p as y,r as b,s as x,t as S,u as C}from"./sortable-DtRaFfbB.js";var w=e({renderComprasSection:()=>k}),T={value:null},E=null,D=0,O=0;function k(){let e=document.getElementById(`compras-section`);if(!e)return;let{items:t,filters:r}=n.compras,a=p(r.length>0?t.filter(e=>r.includes(e.categoria)):t),o={supermercado:t.filter(e=>e.categoria===`supermercado`).length,internet:t.filter(e=>e.categoria===`internet`).length,farmacia:t.filter(e=>e.categoria===`farmacia`).length},s=[`supermercado`,`internet`,`farmacia`],c=a.length===0,l=r.length>0?`Sin resultados`:`Lista vacía`,u=r.length>0?`No hay productos en `+i(r[0]):`Añade productos a tu lista de compras`;if(e.innerHTML=`
    <div class="stats-bar">
      ${s.map(e=>`
