...
import{i as e}from"./storage-BPwMTOLr.js";import{a as t}from"./firebase-CpRCSNy3.js";import{n}from"./store-DsijVbw0.js";import{a as r,h as i,o as a,r as o,s,t as c}from"./dataService-Dg8tCN3C.js";import{_ as l,a as u,c as d,d as f,f as p,h as m,i as h,l as g,m as _,o as v,p as y,r as b,s as x,t as S,u as C}from"./sortable-DtRaFfbB.js";var w=e({renderIdeasSection:()=>E}),T={value:null};function E(){let e=document.getElementById(`ideas-section`);if(!e)return;let{items:t,searchQuery:r}=n.ideas,i=t;r&&(i=t.filter(e=>e.titulo&&e.titulo.toLowerCase().includes(r.toLowerCase())||e.notas&&e.notas.toLowerCase().includes(r.toLowerCase())));let a=l(i),o=t.length,s=t.filter(e=>e.archivada).length;if(e.innerHTML=`
    <div class="stats-bar">
      <div class="stat-item">
